...
//მივახატოთ ანტენები:
		GLine robotAnten = new GLine (middleX-100+30, middleY-100, middleX-100+30, middleY-100-60);
		add(robotAnten);
		
		robotAnten = new GLine (middleX+100-30, middleY-100, middleX+100-30, middleY-100-60);
		add(robotAnten);
	}
